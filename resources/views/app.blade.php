...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        @endif
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-20 bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
    ...
    @vite('node_modules/flatpickr/dist/flatpickr.js')
    @vite('node_modules/simple-datatables/dist/index.js')
</html>
